...
export const barbercrmThemeConfig: ThemeConfig = {
  // ==========================================
  // BASIC IDENTIFICATION
  // ==========================================
  name: 'barbercrm',
  displayName: 'BarberCRM',
  version: '1.0.0',
  description: 'A modern SaaS application built with NextSpark',
...
export default barbercrmThemeConfig
